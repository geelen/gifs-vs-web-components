...
},{"/Users/glen/src/projects/x-gif/node_modules/gulp-browserify/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":2}],2:[function(require,module,exports){
...
var $__default = (function() {
  var Gif = function Gif(frames) {
    ...
    frames.forEach((function(frame) {
      $__0.offsets.push($__0.length);
      $__0.length += (frame.delay || defaultFrameDelay);
    }));
  };
  return ($traceurRuntime.createClass)(Gif, {frameAt: function(fraction) {
...
var Exploder = $traceurRuntime.assertObject(require('./exploder.js')).default;
function addClasses(element, frame) {
  element.classList.add('frame');
  if (frame.disposal == 2)
    element.classList.add('disposal-restore');
}
...
var $__default = (function() {
  var Playback = function Playback(xgif, element, file, opts) {
    var $__0 = this;
    this.xgif = xgif;
  ...
  return ($traceurRuntime.createClass)(Playback, {
    ...
    setFrame: function(fraction, repeatCount) {
    ...
    startSpeed: function(speed, nTimes) {
      ...
      this.animationLoop = (function() {
        var gifLength = 10 * $__0.gif.length / $__0.speed,
...
var $__default = (function() {
  ...
  return ($traceurRuntime.createClass)(StreamReader, {
    finished: function() {
